    ...
    this.init = function () {
      ! function () {
        ...
        (I = PIXI.autoDetectRenderer(G, A, {
          backgroundColor: 16756655,  // pink, #FFAFAF
          antialias: !1,
          resolution: n
    ...
    B && ($("#bt_fs").css("display", "block"), $("#bt_fs").click(function (n) {
      ...
      switch (x) {
        case 1:
          ...
          break;
        default:
          location.href = "https://github.com/Kahsolt/hana-tap/"
      }
    ...
    var m, I, z, b = 0,
        ...
        this.init = function (n, a) {
          f = a,
            function (n) {
              ...
              (r = new WebAudioManager).load("static/data/track/track.json", a, t, i)
            }(n)
        ...
        this.init = function (n, a) {
          e = a,
            function (n) {
              ...
              (o = new WebAudioManager).load("static/data/main/main.json", a, t, i)
            }(n)
        };
      ...
      g = new function () {
        ...
        this.resize = function () {
          ...
          // NOTE: the init background color of <canvas>, set it to your main color
          w = !0, b = new PIXI.Container, z.addChild(b), f = new PIXI.Container, z.addChild(f), (T = new n(b)).setColor(10200631, 0)
        }, this.start = function () {
        ...
        // NOTE: replace with your colorset
        var T, P = [4276553, 11313314, 11905831, 9080715, 16119024, 11976556, 14012126, 14596961, 14078136, 14080733, 16309949, 16748397],
          k = [4276553, 11313314, 11905831, 9080715, 16119024, 11976556, 14012126, 14596961, 14078136, 14080733, 16309949, 16748397],
          _ = P.length,
          O = 0;
